                ...
                $("#btnCreateScheduledChange").click(function () {
                    ...
                    var change =
                            { "ID": AssociateId ,
                               ...
                               "VATRegistered" :($("#ScheduledVATRegistered").prop("checked") ? "True" : "False") ,
                               "DateVatDeRegistered" :varVATdeRegisteredDate ,
                               "VATRegistration" :$("#ScheduledVATRegistrationNumber").val() ,
                               "DateVatRegistered" :varVATRegDate ,
                               "SageId" :$("#ScheduledSageId").val() ,
