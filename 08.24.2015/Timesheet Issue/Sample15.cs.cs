...
namespace MR_DAL.TimeSheet.Repository
{
    ...
    public interface ITimeSheetRepository
    {
        ...
        void UpdateTimeSheetEntryNote(int id, string accomodation, string mealAllowance, string travel, string noOfMiles, string parkingNotes, string other);
        ...
        IEnumerable<ExpensesRecieptDetails> GetRecieptInfo(int roleId,  int associateId);
